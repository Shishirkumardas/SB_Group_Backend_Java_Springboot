...
//    }
    ...
    public Product updateProduct(Long id, ProductDTO dto) {
        ...
        // 2. Update basic fields (only if provided / changed)
...
//            if (!savedImageUrls.isEmpty()) {
//                // Replace all images
//                product.setImageUrl(savedImageUrls.get(0));           // first = main
//                product.setExtraImages(savedImageUrls);               // all go to extras too
//            }
//            // If no valid images were saved → keep old ones (intentional no-op)
        }
        // 4. Assign images properly
        if (!savedImageUrls.isEmpty()) {
            // First image = main imageUrl
        ...
        // If dto.getImages() is empty or null → keep existing images unchanged
